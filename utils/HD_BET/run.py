...
from utils.HD_BET.data_loading import load_and_preprocess, save_segmentation_nifti
...
def run_hd_bet(mri_fnames, output_fnames, mode="accurate", config_file=os.path.join(utils.HD_BET.__path__[0], "config.py"), device=0,
